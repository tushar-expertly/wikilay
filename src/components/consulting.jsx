    ...
    <Layout>
      ...
      <div className="">
        <div className="max-w-4xl mx-auto px-4 py-8">
          <p className="mb-4">
            Experience the adaptability of expert-led consultation or
            instruction, at the time and place that fits you best.
          </p>

          <p className="mb-4">
            Tell us your needs, and we’ll craft a custom solution to address
            your concerns and maximize benefits for your team.
          </p>

          <h2 className="mb-2 text-lg font-semibold text-gray-900 dark:text-white">
            Our bespoke consulting/training services feature:
          </h2>
          <ul className="max-w-md space-y-1 list-disc list-inside dark:text-gray-400">
            <li> A curriculum tailored to your goals.</li>
            <li>Flexible scheduling and delivery.</li>
            <li>Access to expert instructors.</li>
            <li>Scalable training solutions for any group size.</li>
          </ul>
        </div>
      </div>
      ...
      <section className="bg-white dark:bg-gray-900">
        <div className="container px-4 py-8 mx-auto md:w-2/3">
          <p className="mt-2 text-lg text-gray-800 font-medium leading-relaxed bg-clip-text">
            Request a personalized estimate today and achieve tailored training
            excellence.
          </p>
